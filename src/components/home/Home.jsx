    ...
    return (
        <>
            <div class="container">
                <div class="content">
                    <h2>Who we are?</h2>
                    <p>We are a company dedicated to offering good service and ease in your reservations. Your peace of mind is our service</p>
                    <Link to="/hoteles" class="button">Hotels »</Link>
                </div>
                <div class="image">
